...
import { 
  ...
  MessageSquare, User, Map, School, FileText, StickyNote, DoorOpen, Activity, CloudUpload, CloudDownload, Loader2, Bell
} from 'lucide-react';
...
export default function HomeroomPage() {
    ...
    const permissions = usePermissions('/monitoring/homeroom');
