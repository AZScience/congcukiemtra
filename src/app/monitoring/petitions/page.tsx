...
import { 
  ...
  IdCard, Phone, FileText, Reply, MessageSquare, Landmark, List, StickyNote, Map, CloudUpload, CloudDownload, Hash, History
} from 'lucide-react';
...
export default function PetitionsPage() {
    ...
    const { permissions } = usePermissions('/monitoring/petitions');
